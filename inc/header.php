...
<head>
  ...
  <title>Bhumika's Store Billing and Inventory Software</title>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <div class="notice">
          <li>
            <i class="material-symbols-outlined">
              <a href="http://www.linkedin.com/in/bhumika-garg-558747284" target="_blank"> notifications</a></i>
          </li>
          <li> <i class="material-symbols-outlined"><a href="mailto: 20230802338@dypiu.ac.in" target="_blank"> mail</a></i></li>
          <li>
            <i class="material-symbols-outlined"><a href="http://www.linkedin.com/in/bhumika-garg-558747284" target="_blank"> redeem</a> </i>
          </li>
        </div>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">
            ...
            <span>Bhumika's <strong>Store</strong></span>
          </a>
