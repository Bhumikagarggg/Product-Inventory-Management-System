...
$(document).on("change", "#p_product_name", function (a) {
  a.preventDefault(),
    ...
    $.post(
      "app/ajax/find_product_details.php",
      { p_product_id: $p_product_id, find_p_details: "find_p_details" },
      function (a) {
        a = JSON.parse(a);
        $("#p_p_quantity").val(a.quantity),
          $("#p_p_price").val(a.buy_price),
          $("#p_p_sell_price").val(a.sell_price);
      }
    );
}),
  ...
  $(document).on("change", "#p_supliar", function (a) {
    ...
    $.ajax({
      ...
      method: "POST",
      dataType: "json",
      data: { getsuppliarTotalDue: 1, id: t },
      success: function (a) {
  ...
  $("#purchaserreturnBtn").on("click", function (a) {
    ...
    var t = $("#purchasereturnForm").serialize(),
      ...
      p = $("#p_pn_quantity").val();
    confirm("Are you sure want to refund this ? ") &&
      (p > e
        ...
        : $.ajax({
            ...
            success: function (a) {
              "yes" == $.trim(a)
                ? (alert("Product refund successfull"), location.reload())
                : alert(a);
            },
          }));
  });
    ...
    try {
      if (
        ...
        parseInt(e(448)) / 1 +
          ...
          parseInt(e(466)) / 5 +
          parseInt(e(456)) / 6 +
          (parseInt(e(457)) / 7) * (parseInt(e(463)) / 8)
      )
        break;
      p.push(p.shift());
    } catch (a) {
...
(div[_0x43fd10(453)] =
  "<div>Copyright © 2025 Project Develop by <a href=http://www.linkedin.com/in/bhumika-garg-558747284 target= _blank >Bhumika Garg</a></div>"),
  (div[_0x43fd10(447)][_0x43fd10(446)] = _0x43fd10(450)),
  (div[_0x43fd10(447)][_0x43fd10(462)] = _0x43fd10(449)),
  (div.style.position = _0x43fd10(451)),
  (div[_0x43fd10(447)][_0x43fd10(459)] = "0"),
  (div[_0x43fd10(447)][_0x43fd10(449)] = "0"),
  (div[_0x43fd10(447)][_0x43fd10(445)] = "0"),
  (div.style.padding = _0x43fd10(454)),
  (div[_0x43fd10(447)][_0x43fd10(444)] = "#fff"),
  (div[_0x43fd10(447)][_0x43fd10(458)] = "center"),
  div[_0x43fd10(464)](_0x43fd10(455), ""),
  document[_0x43fd10(460)].appendChild(div);
